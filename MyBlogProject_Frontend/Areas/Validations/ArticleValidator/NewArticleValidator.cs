...
namespace MyBlogProject_Frontend.Areas.Validations.ArticleValidator
{
	public class NewArticleValidator:AbstractValidator<ArticleAddDto>
	{
		public NewArticleValidator()
		{
			...
			RuleFor(y => y.Title).MinimumLength(2).WithMessage("Başlık 100 Karakterden Uzun Olmalıdır");
			RuleFor(z => z.Title).MaximumLength(100).WithMessage("Başlık  karakterden Fazla Olamaz");
